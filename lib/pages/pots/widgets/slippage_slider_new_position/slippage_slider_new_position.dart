...
import 'controller.dart/slippage_slider_controller.dart';

class SlippageSliderNewPosition
    extends GetView<SlippageSliderNewPositionController> {
  const SlippageSliderNewPosition({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(SlippageSliderNewPositionController());
